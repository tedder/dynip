...
| `PUSH_URL` | no | Pinged after each check/update cycle (e.g. Uptime Kuma) | `http://kuma:5998/api/push/TOKEN?status=up&msg=OK&ping=` |
...
```yaml
  dynip:
    ...
    - PUSH_URL=http://your-uptime-kuma:5998/api/push/TOKEN?status=up&msg=OK&ping=
    - MYNAME=home
